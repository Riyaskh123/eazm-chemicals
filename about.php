     ...
     <!-- Intro Section -->
		<section class="inner-intro light-color overlay-before parallax-background" style="background-image:url('assets/images/about bg1.jpg')">
			<div class="container">
				<div class="row title">
					<div class="title_row">
						<h1 data-title="Service"><span>About</span></h1>
		...
		<div class="container">
			<div class="row pb-30">
				...
				<div class="col-md-8 mt-xs-30 text-center text-md-left">
					<p>
                    At Eazm Chemicals, we are proud to be a global leader in the chemical industry, dedicated to providing innovative and reliable solutions to businesses worldwide. With a legacy built on trust and excellence, we specialize in delivering superior-quality chemical products and tailored services that empower industries to thrive.

Our unwavering commitment to quality, safety, and sustainability drives everything we do. We take pride in offering an extensive portfolio of chemical products that cater to a wide array of industries, ensuring our clients receive the solutions they need to achieve their goals.
                </p>
					<p>
                    At Eazm Chemicals, your success is our mission. We are more than a supplier; we are a trusted partner, committed to delivering value, fostering innovation, and building a better future for industries worldwide.
					</p>
				</div>
			</div>
