...
<body>
				...
				<ul>
					...
					<li data-index="rs-129">
						...
						<div class="tp-caption Newspaper-Title tp-resizeme" id="slide-129-layer-1"
							...
							data-y="['top','top','top','center']" data-voffset="['150','135','50','0']"
							...
							<div class="banner-text">
								...
								<h2>Your Trusted Partner in Chemical</h2>
								<p>
									Providing high-quality chemical products and services to industries worldwide.
								</p>
					...
					<li data-index="rs-130" data-title="" data-description="">
						...
						<div class="tp-caption Newspaper-Title tp-resizeme" id="slide-130-layer-1"
							...
							<div class="banner-text">
								<span class="sub-text">We are here to help you</span>
								<h2>Delivering Quality Chemicals Worldwide</h2>
								<p>
									Tailored solutions to meet your industrial needs with precision and reliability.
								</p>
								<!-- <a class="btn-text" href="#"> Read More</a> -->
							</div>
						</div>
					...
					<li data-index="rs-131">
						...
						<div class="tp-caption Newspaper-Title tp-resizeme" id="slide-131-layer-1"
							...
							<div class="banner-text">
								...
								<p>
									Committed to sustainability with eco-friendly chemical solutions.
								</p>
								<!-- <a class="btn-text" href="#"> Read More</a> -->
							</div>
						</div>
		...
		<div class="container">
			<div class="row pb-30">
				...
				<div class="col-md-8 mt-xs-30 text-center text-md-left">
					<p>
						Eazm Chemicals is a leading name in the chemical industry, known for delivering
						high-quality chemical products and services to industries worldwide. Our extensive experience
						and commitment to excellence make us a trusted partner for businesses across various sectors.
					</p>
					<p>
						With a focus on quality, safety, and sustainability, we offer a wide range of chemical products
						that cater to diverse industry needs. Our global reach and robust supply chain ensure that we
						can meet the demands of our clients efficiently and effectively.
					</p>
				</div>
			</div>
			...
			<div class="row mt-30 mt-xs-0">
				<div class="col-lg-3 col-md-6">
					<div class="clean_top mb-xs-30 feature-box">
						<div class="content">
							<img src="assets/images/expert.svg" alt="" height="50" width="50" />
							<h3>Industry Expertise</h3>
							<p>
								Our team of experts and in depth knowledge of the chemical
								industry.
							</p>
						</div>
					</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="clean_top mb-xs-30 feature-box">
						<div class="content">
							<img src="assets/images/secure.svg" alt="" height="50" width="50" />
							<h3>Secure Transactions</h3>
							<p>
								We ensure secure, transparent, and compliant transactions.
							</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 mt-sm-30">
					<div class="clean_top mb-xs-30 feature-box">
						<div class="content">
							<img src="assets/images/cost.svg" alt="" height="50" width="50" />
							<h3>Cost-Effective</h3>
							<p>
								We provide high-quality products at competitive prices to help you maximize value.
							</p>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 mt-sm-30">
					<div class="clean_top mb-xs-30 feature-box">
						<div class="content">
							<img src="assets/images/time.svg" alt="" height="50" width="50" />
							<h3>Timely Deliveries</h3>
							<p>
								Our reliable logistics network ensures your orders are delivered on time, every time.
							</p>
						</div>
					</div>
				</div>
	...
	<!-- Service_Section -->
	<section class="padding ptb-xs-40 service-bg service_sec">
		<div class="container">
			<div class="row text-center mb-xs-30">
				<div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
					<div class="section-title_home">
						...
						<p class="text-white">
							Eazm Chemicals offers a wide range of specialized services to meet the diverse needs of our
				...
				<div class="col-md-12">
					<div class="d-flex row p-2">	
						<div class="service_box col-sm-12 col-md-4">
							...
							<h3><a href="#">Custom Packing</a></h3>
							<p>
								Tailored packaging solutions to ensure your products are safely and efficiently packaged
						...
						<div class="service_box col-sm-12 col-md-4">
							...
							<h3><a href="#">Chemical Distribution</a></h3>
							<p>
								Efficient distribution of high-quality chemicals, delivered with reliability and
								precision.
							</p>
						</div>
						...
						<div class="service_box col-sm-12 col-md-4">
							...
							<h3><a href="#">Export and Import Services</a></h3>
							<p>
								Comprehensive export and import services to navigate the complexities of global trade
								seamlessly.
							</p>
						</div>
						...
						<div class="service_box col-sm-12 col-md-6">
							...
							<h3><a href="#">Technical Services</a></h3>
							<p>
		...
		<div class="container">
				...
				<div class="col-md-8 offset-md-2 col-lg-6 offset-lg-3">
					<div class="section-title_home">
						...
						<!-- <p>
							...
							been the 's standard dummy text.
						</p> -->
					</div>
				</div>
			</div>
			...
			<!-- <div class="row">
				<div class="col-lg-8 offset-lg-2">
					<ul class="container-filter categories-filter">
						...
						<li>
							<a class="categories" data-filter=".branding">Category 1</a>
						</li>
						<li>
							<a class="categories" data-filter=".design">Category 2</a>
						</li>
						<li>
							<a class="categories" data-filter=".photo">Category 3</a>
						</li>
					</ul>
				</div>
			</div> -->
			...
			<div class="row container-grid nf-col-3">
				...
				<div class="nf-item branding coffee spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_1.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_1.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Adhesives</a></h4>
							</div>
						</div>
				...
				<div class="nf-item photo spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_2.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_2.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Soap & Detergent</a></h4>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="nf-item branding coffee spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_3.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_3.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Cosmetics & Perfumery</a></h4>
							</div>
						</div>
				...
				<div class="nf-item design spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_4.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_4.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Oil Field, Refinery & Lubricants</a></h4>
							</div>
						</div>
				...
				<div class="nf-item branding spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_5.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_5.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Paints & InkPaints & Ink</a></h4>
							</div>
						</div>
				...
				<div class="nf-item photo spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_6.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_6.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Paper, Printing
								& Packaging</a></h4>
							</div>
						</div>
				...
				<div class="nf-item photo spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_7.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_7.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Power Generation</a></h4>
							</div>
						</div>
				...
				<div class="nf-item photo spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_8.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_8.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Water Treatment</a></h4>
							</div>
						</div>
				...
				<div class="nf-item photo spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_9.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_9.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Mining</a></h4>
							</div>
						</div>
				...
				<div class="nf-item photo spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_10.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_10.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Cleaning Chemicals</a></h4>
							</div>
						</div>
				...
				<div class="nf-item photo spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_11.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_11.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Ceramic</a></h4>
							</div>
						</div>
				...
				<div class="nf-item photo spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_12.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_12.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
				...
				<div class="nf-item photo spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_13.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_13.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Fiberglass & Foam</a></h4>
							</div>
						</div>
				...
				<div class="nf-item photo spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_14.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_14.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Construction Chemicals</a></h4>
							</div>
						</div>
				...
				<div class="nf-item photo spacing">
					<div class="item-box">
						<a> <img alt="1" src="assets/images/product/product_15.jpg" class="item-container"> </a>
						<div class="link-zoom">
							<a href="assets/images/product/product_15.jpg" class="fancylight popup-btn same_style"
								data-fancybox-group="light"> <i class="fa fa-search-plus"></i> </a>
							<div class="gallery-heading">
								<h4><a href="#">Metal Coating & Galvanizing</a></h4>
							</div>
						</div>
	...
	<script>
		jQuery('#rev_slider_34_1').show().revolution({
			sliderLayout: 'auto',
			delay: 4000,
			/* MIN-HEIGHT */
			minHeight: '600',
